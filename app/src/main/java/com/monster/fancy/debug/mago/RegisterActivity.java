...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText reg_username_edt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg_username_edt = (EditText) findViewById(R.id.reg_username_edt);
...
//        startActivity(intent);
    ...
    private void attempRegister() {
        String username = reg_username_edt.getText().toString();
        ...
        if (TextUtils.isEmpty(username)) {
            reg_username_edt.setError(getString(R.string.error_empty_username));
            focusView = reg_username_edt;
            cancel = true;
        }
